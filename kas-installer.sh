...
read_kas_installer_env_file() {
  ...
  KAFKA_CAPACITY_INGRESS_THROUGHPUT=${KAFKA_CAPACITY_INGRESS_THROUGHPUT:-2Mi}
  KAFKA_CAPACITY_EGRESS_THROUGHPUT=${KAFKA_CAPACITY_EGRESS_THROUGHPUT:-2Mi}
  KAFKA_CAPACITY_TOTAL_MAX_CONNECTIONS=${KAFKA_CAPACITY_TOTAL_MAX_CONNECTIONS:-100}
  KAFKA_CAPACITY_MAX_DATA_RETENTION_SIZE=${KAFKA_CAPACITY_MAX_DATA_RETENTION_SIZE:-60Gi}
  KAFKA_CAPACITY_MAX_PARTITIONS=${KAFKA_CAPACITY_MAX_PARTITIONS:-100}
  KAFKA_CAPACITY_MAX_DATA_RETENTION_PERIOD=${KAFKA_CAPACITY_MAX_DATA_RETENTION_PERIOD:-P14D}
  KAFKA_CAPACITY_MAX_CONNECTION_ATTEMPTS_PER_SEC=${KAFKA_CAPACITY_MAX_CONNECTION_ATTEMPTS_PER_SEC:-100}
...
generate_kas_fleet_manager_env_config() {
  ...
  echo "KAFKA_CAPACITY_INGRESS_THROUGHPUT=${KAFKA_CAPACITY_INGRESS_THROUGHPUT}" >> ${KAS_FLEET_MANAGER_DEPLOY_ENV_FILE}
  echo "KAFKA_CAPACITY_EGRESS_THROUGHPUT=${KAFKA_CAPACITY_EGRESS_THROUGHPUT}" >> ${KAS_FLEET_MANAGER_DEPLOY_ENV_FILE}
  echo "KAFKA_CAPACITY_TOTAL_MAX_CONNECTIONS=${KAFKA_CAPACITY_TOTAL_MAX_CONNECTIONS}" >> ${KAS_FLEET_MANAGER_DEPLOY_ENV_FILE}
  echo "KAFKA_CAPACITY_MAX_DATA_RETENTION_SIZE=${KAFKA_CAPACITY_MAX_DATA_RETENTION_SIZE}" >> ${KAS_FLEET_MANAGER_DEPLOY_ENV_FILE}
  echo "KAFKA_CAPACITY_MAX_PARTITIONS=${KAFKA_CAPACITY_MAX_PARTITIONS}" >> ${KAS_FLEET_MANAGER_DEPLOY_ENV_FILE}
  echo "KAFKA_CAPACITY_MAX_DATA_RETENTION_PERIOD=${KAFKA_CAPACITY_MAX_DATA_RETENTION_PERIOD}" >> ${KAS_FLEET_MANAGER_DEPLOY_ENV_FILE}
  echo "KAFKA_CAPACITY_MAX_CONNECTION_ATTEMPTS_PER_SEC=${KAFKA_CAPACITY_MAX_CONNECTION_ATTEMPTS_PER_SEC}" >> ${KAS_FLEET_MANAGER_DEPLOY_ENV_FILE}
