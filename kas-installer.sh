...
generate_runtime_env_config() {
  ...
  echo "IMAGE_REGISTRY=${KAS_FLEET_MANAGER_IMAGE_REGISTRY}" >> ${KAS_INSTALLER_RUNTIME_ENV_FILE}
  echo "IMAGE_REPOSITORY=${KAS_FLEET_MANAGER_IMAGE_REPOSITORY}" >> ${KAS_INSTALLER_RUNTIME_ENV_FILE}
  echo "IMAGE_TAG=${KAS_FLEET_MANAGER_IMAGE_TAG}" >> ${KAS_INSTALLER_RUNTIME_ENV_FILE}
  echo "IMAGE_BUILD=${KAS_FLEET_MANAGER_IMAGE_BUILD}" >> ${KAS_INSTALLER_RUNTIME_ENV_FILE}

  echo "IMAGE_REPOSITORY_USERNAME=${KAS_FLEET_MANAGER_IMAGE_REPOSITORY_USERNAME}" >> ${KAS_INSTALLER_RUNTIME_ENV_FILE}
  echo "IMAGE_REPOSITORY_PASSWORD=${KAS_FLEET_MANAGER_IMAGE_REPOSITORY_PASSWORD}" >> ${KAS_INSTALLER_RUNTIME_ENV_FILE}
  echo "KAS_FLEET_MANAGER_SERVICE_TEMPLATE_PARAMS=${KAS_FLEET_MANAGER_SERVICE_TEMPLATE_PARAMS}" >> ${KAS_INSTALLER_RUNTIME_ENV_FILE}
  echo "KAS_FLEET_MANAGER_SECRETS_TEMPLATE_PARAMS=${KAS_FLEET_MANAGER_SECRETS_TEMPLATE_PARAMS}" >> ${KAS_INSTALLER_RUNTIME_ENV_FILE}
  echo "OCM_SERVICE_TOKEN=${OCM_SERVICE_TOKEN}" >> ${KAS_INSTALLER_RUNTIME_ENV_FILE}

  echo "KAS_FLEET_MANAGER_NAMESPACE=kas-fleet-manager-${USER}" >> ${KAS_INSTALLER_RUNTIME_ENV_FILE}
