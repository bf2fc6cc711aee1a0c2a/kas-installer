...
read_kas_installer_env_file() {
  ...
  KAS_FLEET_MANAGER_IMAGE_TAG=${KAS_FLEET_MANAGER_IMAGE_TAG:-087b478}
  KAS_FLEET_MANAGER_IMAGE_REPOSITORY_USERNAME=${KAS_FLEET_MANAGER_IMAGE_REPOSITORY_USERNAME:-${IMAGE_REPOSITORY_USERNAME}}
  KAS_FLEET_MANAGER_IMAGE_REPOSITORY_PASSWORD=${KAS_FLEET_MANAGER_IMAGE_REPOSITORY_PASSWORD:-${IMAGE_REPOSITORY_USERNAME}}
  # TODO update this to a 'main' when we have 'main' container image available
  KAS_FLEET_MANAGER_BF2_REF=${KAS_FLEET_MANAGER_BF2_REF:-e7df1ec6f408e8079f8bb462f416536788500f10}
}
